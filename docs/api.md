...
| --- | --- | --- | --- |
| `UsosClient` | `new UsosClient(options)` | Anonymous or Consumer | `apiref`, `apisrv`, `calendar`, `courses`, `crstests`, `examrep`, `examrep2`, `exams`, `fac`, `grades`, `groups`, `oauth`, `payments`, `progs`, `registrations`, `terms`, `theses`, `tt`, `users` |
